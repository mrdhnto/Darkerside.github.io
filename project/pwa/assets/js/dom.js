  ...
  if(match.length === 0){
    ...
    match.forEach(match => {
      savedHTML += `
            <div class="row card saved-data">
              <div class="saved-content">
                <a href="./match.html?id=${match.id}&saved=true"><div class="col s5 truncate saved-title">${match.homeTeam.name}</div></a>
                <a href="./match.html?id=${match.id}&saved=true"><div class="col s1 saved-title center-align">-</div></a>
                <a href="./match.html?id=${match.id}&saved=true"><div class="col s5 saved-title right-align truncate">${match.awayTeam.name}</div></a>
